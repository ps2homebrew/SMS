...
#define g_SCPaint (  ( u64*           )&g_SMSounds[  3600 ]  )
#define g_SCErase (  ( u64*           )&g_SMSounds[  5792 ]  )
#define g_VCPaint (  ( u64*           )&g_SMSounds[  5920 ]  )
#define g_VCErase (  ( u64*           )&g_SMSounds[  6480 ]  )
#define g_Balls   (  ( void*          )&g_SMSounds[  6640 ]  )
#define g_BallPkt (  ( u64*           )&g_SMSounds[ 12784 ]  )
#define g_DErase  (  ( u64*           )&g_SMSounds[ 29248 ]  )
#define g_DPaint  (  ( u64*           )&g_SMSounds[ 29296 ]  )
#define g_OSDNR   (  ( u64*           )&g_SMSounds[ 29776 ]  )
#define g_VRStack (  ( unsigned char* )&g_SMSounds[ 30080 ]  )
#define g_ARStack (  ( unsigned char* )&g_SMSounds[ 46464 ]  )
#define g_SPCPkt  (  ( u64*           )&g_SMSounds[ 62848 ]  )
#define g_FFTWsp  (  ( u64*           )&g_SMSounds[ 64032 ]  )
#define g_Speaker (  ( u64*           )&g_SMSounds[ 68128 ]  )
