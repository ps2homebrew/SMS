...
# define SMS_VU0_MPG_OFFSET    (  ( SMS_SIO2MAN_OFFSET    + SMS_SIO2MAN_SIZE    + 15 ) & 0xFFFFFFF0  )
# define SMS_VU0_DATA_OFFSET   (  ( SMS_VU0_MPG_OFFSET    + SMS_VU0_MPG_SIZE    + 15 ) & 0xFFFFFFF0  )
# define SMS_DATA_BUFFER_SIZE  (  ( SMS_VU0_DATA_OFFSET   + SMS_VU0_DATA_SIZE   + 15 ) & 0xFFFFFFF0  )
