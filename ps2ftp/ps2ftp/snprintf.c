 ...
 *		  also be more careful in the use of signed/unsigned/int
...
int asnprintf  (char **ptr, int str_m, const char *fmt, /*args*/ ...);
#endif
#if defined(NEED_VASNPRINTF)
int vasnprintf (char **ptr, int str_m, const char *fmt, va_list ap);
#endif
...
int portable_snprintf(char *str, int str_m, const char *fmt, /*args*/ ...);
#if !defined(NEED_SNPRINTF_ONLY)
int portable_vsnprintf(char *str, int str_m, const char *fmt, va_list ap);
#endif
#endif
...
int asprintf(char **ptr, const char *fmt, /*args*/ ...) {
  ...
  *ptr = NULL;
  ...
  str_l = portable_vsnprintf(NULL, (int)0, fmt, ap);
  va_end(ap);
  assert(str_l >= 0);        /* possible integer overflow if str_m > INT_MAX */
  *ptr = (char *) malloc(str_m = (int)str_l + 1);
...
int vasprintf(char **ptr, const char *fmt, va_list ap) {
  ...
  *ptr = NULL;
  { va_list ap2;
    ...
    str_l = portable_vsnprintf(NULL, (int)0, fmt, ap2);/*get required size*/
    va_end(ap2);
  }
  assert(str_l >= 0);        /* possible integer overflow if str_m > INT_MAX */
  *ptr = (char *) malloc(str_m = (int)str_l + 1);
...
int asnprintf (char **ptr, int str_m, const char *fmt, /*args*/ ...) {
  ...
  *ptr = NULL;
  ...
  va_end(ap);
  assert(str_l >= 0);        /* possible integer overflow if str_m > INT_MAX */
  if ((int)str_l + 1 < str_m) str_m = (int)str_l + 1;      /* truncate */
 ...
 * This is more useful than the old:  if (str_m < 1) return -1; */
  ...
  while (*p) {
    ...
    * where format string is long and contains few conversions */
      ...
      int str_arg_l;         /* natural field width of arg without padding
                                   and sign */
   ...
   /* parse field width */
      if (*p == '*') {
        ...
        /* int could be wider than unsigned int;
...
#  endif
   ...
   * int, and snprintf is int, possibly leading to an undetected
