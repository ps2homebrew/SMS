...
#define PS2_GS_SETREG_COLCLAMP(clamp) ((u64)(clamp))
...
#define PS2_GS_SETREG_DTHE(dthe) ((u64)(dthe))

#define PS2_GS_SETREG_FBA_1	PS2_GS_SETREG_FBA
#define PS2_GS_SETREG_FBA_2	PS2_GS_SETREG_FBA
#define PS2_GS_SETREG_FBA(fba) ((u64)(fba))

#define PS2_GS_SETREG_FOG(f) ((u64)(f) << 56)
...
#define PS2_GS_SETREG_PABE(pabe) ((u64)(pabe))
...
#define PS2_GS_SETREG_PRMODECONT(ac) ((u64)(ac))

#define PS2_GS_SETREG_RGBAQ(r, g, b, a, q) \
	((u64)(r)        | ((u64)(g) << 8) | ((u64)(b) << 16) | \
	((u64)(a) << 24) | ((u64)(q) << 32))

#define PS2_GS_SETREG_SCANMSK(msk) ((u64)(msk))
...
#define PS2_GS_SETREG_ST(s, t) ((u64)(s) |  ((u64)(t) << 32))
...
#define PS2_GS_SETREG_TRXDIR(xdr) ((u64)(xdr))
...
#define PS2_GS_CLEAR_GSREG(p)	*(u64 *)(p) = 0
/* ALPHA */
typedef struct {
	...
	u64 pad8:  24 __attribute__((packed));
	u64 FIX:    8 __attribute__((packed));
	u64 pad40: 24 __attribute__((packed));
...
typedef struct {
	...
	u64 pad14:  2 __attribute__((packed));
	u64 SBW:    6 __attribute__((packed));
	u64 pad22:  2 __attribute__((packed));
	u64 SPSM:   6 __attribute__((packed));
	u64 pad30:  2 __attribute__((packed));
	u64 DBP:   14 __attribute__((packed));
	u64 pad46:  2 __attribute__((packed));
	u64 DBW:    6 __attribute__((packed));
	u64 pad54:  2 __attribute__((packed));
	u64 DPSM:   6 __attribute__((packed));
	u64 pad62:  2 __attribute__((packed));
} ps2_gsreg_bitbltbuf __attribute__((packed));

/* CLAMP */
typedef struct {
	u64 WMS:    2 __attribute__((packed));
	u64 WMT:    2 __attribute__((packed));
	u64 MINU:  10 __attribute__((packed));
	u64 MAXU:  10 __attribute__((packed));
	u64 MINV:  10 __attribute__((packed));
	u64 MAXV:  10 __attribute__((packed));
	u64 pad44: 20 __attribute__((packed));
...
typedef struct {
	...
	u64 pad01: 63 __attribute__((packed));
...
/* DIMX */
typedef struct {
	u64 DM00:  3 __attribute__((packed));
	u64 pad03: 1 __attribute__((packed));
	u64 DM01:  3 __attribute__((packed));
	u64 pad07: 1 __attribute__((packed));
	u64 DM02:  3 __attribute__((packed));
	u64 pad11: 1 __attribute__((packed));
	u64 DM03:  3 __attribute__((packed));
	u64 pad15: 1 __attribute__((packed));
	u64 DM10:  3 __attribute__((packed));
	u64 pad19: 1 __attribute__((packed));
	u64 DM11:  3 __attribute__((packed));
	u64 pad23: 1 __attribute__((packed));
	u64 DM12:  3 __attribute__((packed));
	u64 pad27: 1 __attribute__((packed));
	u64 DM13:  3 __attribute__((packed));
	u64 pad31: 1 __attribute__((packed));
	u64 DM20:  3 __attribute__((packed));
	u64 pad35: 1 __attribute__((packed));
	u64 DM21:  3 __attribute__((packed));
	u64 pad39: 1 __attribute__((packed));
	u64 DM22:  3 __attribute__((packed));
	u64 pad43: 1 __attribute__((packed));
	u64 DM23:  3 __attribute__((packed));
	u64 pad47: 1 __attribute__((packed));
	u64 DM30:  3 __attribute__((packed));
	u64 pad51: 1 __attribute__((packed));
	u64 DM31:  3 __attribute__((packed));
	u64 pad55: 1 __attribute__((packed));
	u64 DM32:  3 __attribute__((packed));
	u64 pad59: 1 __attribute__((packed));
	u64 DM33:  3 __attribute__((packed));
	u64 pad63: 1 __attribute__((packed));
...
/* FBA */
typedef struct {
	u64 FBA:   1 __attribute__((packed));
	u64 pad01: 63 __attribute__((packed));
} ps2_gsreg_fba __attribute__((packed));

/* FINISH */
typedef struct {
	u64 pad00: 64 __attribute__((packed));
} ps2_gsreg_finish __attribute__((packed));

/* FOG */
typedef struct {
	u64 pad00: 56 __attribute__((packed));
	u64 F:      8 __attribute__((packed));
} ps2_gsreg_fog __attribute__((packed));

/* FOGCOL */
typedef struct {
	u64 FCR:    8 __attribute__((packed));
	u64 FCG:    8 __attribute__((packed));
	u64 FCB:    8 __attribute__((packed));
	u64 pad24: 40 __attribute__((packed));
} ps2_gsreg_fogcol __attribute__((packed));

/* FRAME */
typedef struct {
	u64 FBP:    9 __attribute__((packed));
	u64 pad09:  7 __attribute__((packed));
...
typedef struct {
	u64 DATA: 64 __attribute__((packed));
} ps2_gsreg_hwreg __attribute__((packed));

/* LABEL */
typedef struct {
	u64 ID:    32 __attribute__((packed));
	u64 IDMSK: 32 __attribute__((packed));
} ps2_gsreg_label __attribute__((packed));

/* MIPTBP1 */
typedef struct {
	u64 TBP1:  14 __attribute__((packed));
	u64 TBW1:   6 __attribute__((packed));
	u64 TBP2:  14 __attribute__((packed));
	u64 TBW2:   6 __attribute__((packed));
	u64 TBP3:  14 __attribute__((packed));
	u64 TBW3:   6 __attribute__((packed));
	u64 pad60:  4 __attribute__((packed));
} ps2_gsreg_miptbp1 __attribute__((packed));

/* MIPTBP2 */
typedef struct {
	u64 TBP4:  14 __attribute__((packed));
	u64 TBW4:   6 __attribute__((packed));
	u64 TBP5:  14 __attribute__((packed));
	u64 TBW5:   6 __attribute__((packed));
	u64 TBP6:  14 __attribute__((packed));
	u64 TBW6:   6 __attribute__((packed));
	u64 pad60:  4 __attribute__((packed));
} ps2_gsreg_miptbp2 __attribute__((packed));

/* PABE */
typedef struct {
	u64 PABE:   1 __attribute__((packed));
	u64 pad01: 63 __attribute__((packed));
...
typedef struct {
	...
	u64 pad11: 53 __attribute__((packed));
...
/* PRMODE */
typedef struct {
	u64 pad00:  3 __attribute__((packed));
	u64 IIP:    1 __attribute__((packed));
	u64 TME:    1 __attribute__((packed));
	u64 FGE:    1 __attribute__((packed));
	u64 ABE:    1 __attribute__((packed));
...
/* SCANMSK */
typedef struct {
	u64 MSK:    2 __attribute__((packed));
	u64 pad02: 62 __attribute__((packed));
...
typedef struct {
	...
	u64 pad11:  5 __attribute__((packed));
	u64 SCAX1: 11 __attribute__((packed));
	u64 pad27:  5 __attribute__((packed));
	u64 SCAY0: 11 __attribute__((packed));
	u64 pad43:  5 __attribute__((packed));
	u64 SCAY1: 11 __attribute__((packed));
	u64 pad59:  5 __attribute__((packed));
...
typedef struct {
	...
	u64 pad19: 45 __attribute__((packed));
...
typedef struct {
	...
	u64 pad01:  1 __attribute__((packed));
	...
	u64 pad10:  9 __attribute__((packed));
	u64 L:      2 __attribute__((packed));
	u64 pad21: 11 __attribute__((packed));
...
/* TEX2 */
typedef struct {
	u64 pad00: 20 __attribute__((packed));
	u64 PSM:    6 __attribute__((packed));
	u64 pad26: 11 __attribute__((packed));
	u64 CBP:   14 __attribute__((packed));
	u64 CPSM:   4 __attribute__((packed));
	u64 CSM:    1 __attribute__((packed));
	u64 CSA:    5 __attribute__((packed));
...
/* TEXA */
typedef struct {
	u64 TA0:    8 __attribute__((packed));
	u64 pad08:  7 __attribute__((packed));
	u64 AEM:    1 __attribute__((packed));
	u64 pad16: 16 __attribute__((packed));
	u64 TA1:    8 __attribute__((packed));
	u64 pad40: 24 __attribute__((packed));
...
/* TEXCLUT */
typedef struct {
	u64 CBW:    6 __attribute__((packed));
	u64 COU:    6 __attribute__((packed));
	u64 COV:   10 __attribute__((packed));
	u64 pad22: 42 __attribute__((packed));
} ps2_gsreg_texclut;
...
typedef struct {
	...
	u64 pad61:  3 __attribute__((packed));
...
typedef struct {
	...
	u64 pad12: 20 __attribute__((packed));
...
typedef struct {
	...
	u64 pad30: 34 __attribute__((packed));
...
typedef struct {
	...
	u64 pad48: 16 __attribute__((packed));
...
typedef struct {
	...
	u64 pad09: 15 __attribute__((packed));
	u64 PSM:    4 __attribute__((packed));
	u64 pad28:  4 __attribute__((packed));
	u64 ZMSK:   1 __attribute__((packed));
	u64 pad33: 31 __attribute__((packed));
...
typedef struct {
	...
	u64 pad20: 12 __attribute__((packed));
	u64 DBX:   11 __attribute__((packed));
	u64 DBY:   11 __attribute__((packed));
	u64 pad54: 10 __attribute__((packed));
...
typedef struct {
	...
	u64 pad29:  3 __attribute__((packed));
	u64 DW:    12 __attribute__((packed));
	u64 DH:    11 __attribute__((packed));
	u64 pad55:  9 __attribute__((packed));
} ps2_gssreg_display __attribute__((packed));

/* EXTBUF */
typedef struct {
	u64 EXBP:  14 __attribute__((packed));
	u64 EXBW:   6 __attribute__((packed));
	u64 FBIN:   2 __attribute__((packed));
	u64 WFFMD:  1 __attribute__((packed));
	u64 EMODA:  2 __attribute__((packed));
	u64 EMODC:  2 __attribute__((packed));
	u64 pad27:  5 __attribute__((packed));
	u64 WDX:   11 __attribute__((packed));
	u64 WDY:   11 __attribute__((packed));
	u64 pad54: 10 __attribute__((packed));
...
/* EXTWRITE */
typedef struct {
	u64 EXTWRITE:  1 __attribute__((packed));
	u64 pad01: 63 __attribute__((packed));
...
typedef struct {
	u64 pad00:      8 __attribute__((packed));
	u64 SIGMSK:     1 __attribute__((packed)); /* ro */
	u64 FINISHMSK:  1 __attribute__((packed)); /* ro */
	u64 HSMSK:      1 __attribute__((packed)); /* ro */
	u64 VSMSK:      1 __attribute__((packed)); /* ro */
	u64 reserve12:  1 __attribute__((packed)); /* ro */
	u64 reserve13:  1 __attribute__((packed)); /* ro */
	u64 reserve14:  1 __attribute__((packed)); /* ro */
	u64 pad15:     49 __attribute__((packed));
...
typedef struct {
	...
	u64 reserve16: 17 __attribute__((packed));
	u64 pad33:     31 __attribute__((packed));
...
/* SIGLBLID */
typedef struct {
	u64 SIGID: 32 __attribute__((packed));
	u64 LBLID: 32 __attribute__((packed));
...
typedef struct {
	...
	u64 pad04: 60 __attribute__((packed));
