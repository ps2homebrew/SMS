...
EE_OBJS  = main.o GS.o DMA.o Timer.o IPU.o SMS_Bitio.o SMS_MP3_MMI.o  FileContext.o           \
           SMS_H263.o SMS_DSP.o SMS_DSP_MMI.o SMS_MPEG.o SMS_VLC.o SMS_MPEG4.o SMS_MP3.o      \
           CDDA.o SMS.o SMS_AVI.o SMS_Codec.o SMS_Integer.o SIF.o SMS_AVIPlayer.o SPU.o       \
           SMS_AudioBuffer.o SMS_Data.o SMS_VideoBuffer.o Browser.o GUI.o GUI_Data.o          \
...
EE_CFLAGS := -DRESET_IOP=1 -DVB_SYNC -D_EE -O2 -G8192 -mgpopt -Wall
