...
EE_LIBS     = -lfileXio -lhdd -lpad -lpoweroff -lc -lkernel -laudsrv -lpatches
...
EE_OBJS  = main.o GS.o DMA.o Timer.o IPU.o SMS_Bitio.o SMS_DSP_MMI.o FileContext.o SMS_VLC.o        \
           ...
           Browser.o GUI.o GUI_Data.o GUI_Stub.o StringList.o
...
EE_CFLAGS := -DNO_RTC -DVB_SYNC -D_EE -O2 -G8192 -mgpopt -Wall
