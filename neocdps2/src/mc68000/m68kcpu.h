...
/* Allow for architectures that don't have 8-bit sizes */
	...
	inline static sint MAKE_INT_8(uint value)
	{
...
/* Allow for architectures that don't have 16-bit sizes */
	...
	inline static sint MAKE_INT_16(uint value)
	{
...
/* Allow for architectures that don't have 32-bit sizes */
	...
	inline static sint MAKE_INT_32(uint value)
	{
...
inline static uint m68ki_read_imm_16(void);
inline static uint m68ki_read_imm_32(void);

/* Read data with specific function code */
inline static uint m68ki_read_8_fc  (uint address, uint fc);
inline static uint m68ki_read_16_fc (uint address, uint fc);
inline static uint m68ki_read_32_fc (uint address, uint fc);

/* Write data with specific function code */
inline static void m68ki_write_8_fc (uint address, uint fc, uint value);
inline static void m68ki_write_16_fc(uint address, uint fc, uint value);
inline static void m68ki_write_32_fc(uint address, uint fc, uint value);
#if M68K_SIMULATE_PD_WRITES
inline static void m68ki_write_32_pd_fc(uint address, uint fc, uint value);
#endif /* M68K_SIMULATE_PD_WRITES */

/* Indexed and PC-relative ea fetching */
inline static uint m68ki_get_ea_pcdi(void);
inline static uint m68ki_get_ea_pcix(void);
inline static uint m68ki_get_ea_ix(uint An);

/* Operand fetching */
inline static uint OPER_AY_AI_8(void);
inline static uint OPER_AY_AI_16(void);
inline static uint OPER_AY_AI_32(void);
inline static uint OPER_AY_PI_8(void);
inline static uint OPER_AY_PI_16(void);
inline static uint OPER_AY_PI_32(void);
inline static uint OPER_AY_PD_8(void);
inline static uint OPER_AY_PD_16(void);
inline static uint OPER_AY_PD_32(void);
inline static uint OPER_AY_DI_8(void);
inline static uint OPER_AY_DI_16(void);
inline static uint OPER_AY_DI_32(void);
inline static uint OPER_AY_IX_8(void);
inline static uint OPER_AY_IX_16(void);
inline static uint OPER_AY_IX_32(void);

inline static uint OPER_AX_AI_8(void);
inline static uint OPER_AX_AI_16(void);
inline static uint OPER_AX_AI_32(void);
inline static uint OPER_AX_PI_8(void);
inline static uint OPER_AX_PI_16(void);
inline static uint OPER_AX_PI_32(void);
inline static uint OPER_AX_PD_8(void);
inline static uint OPER_AX_PD_16(void);
inline static uint OPER_AX_PD_32(void);
inline static uint OPER_AX_DI_8(void);
inline static uint OPER_AX_DI_16(void);
inline static uint OPER_AX_DI_32(void);
inline static uint OPER_AX_IX_8(void);
inline static uint OPER_AX_IX_16(void);
inline static uint OPER_AX_IX_32(void);

inline static uint OPER_A7_PI_8(void);
inline static uint OPER_A7_PD_8(void);

inline static uint OPER_AW_8(void);
inline static uint OPER_AW_16(void);
inline static uint OPER_AW_32(void);
inline static uint OPER_AL_8(void);
inline static uint OPER_AL_16(void);
inline static uint OPER_AL_32(void);
inline static uint OPER_PCDI_8(void);
inline static uint OPER_PCDI_16(void);
inline static uint OPER_PCDI_32(void);
inline static uint OPER_PCIX_8(void);
inline static uint OPER_PCIX_16(void);
inline static uint OPER_PCIX_32(void);

/* Stack operations */
inline static void m68ki_push_16(uint value);
inline static void m68ki_push_32(uint value);
inline static uint m68ki_pull_16(void);
inline static uint m68ki_pull_32(void);

/* Program flow operations */
inline static void m68ki_jump(uint new_pc);
inline static void m68ki_jump_vector(uint vector);
inline static void m68ki_branch_8(uint offset);
inline static void m68ki_branch_16(uint offset);
inline static void m68ki_branch_32(uint offset);

/* Status register operations. */
inline static void m68ki_set_s_flag(uint value);            /* Only bit 2 of value should be set (i.e. 4 or 0) */
inline static void m68ki_set_sm_flag(uint value);           /* only bits 1 and 2 of value should be set */
inline static void m68ki_set_ccr(uint value);               /* set the condition code register */
inline static void m68ki_set_sr(uint value);                /* set the status register */
inline static void m68ki_set_sr_noint(uint value);          /* set the status register */

/* Exception processing */
inline static uint m68ki_init_exception(void);              /* Initial exception processing */

inline static void m68ki_stack_frame_3word(uint pc, uint sr); /* Stack various frame types */
inline static void m68ki_stack_frame_buserr(uint sr);

inline static void m68ki_stack_frame_0000(uint pc, uint sr, uint vector);
inline static void m68ki_stack_frame_0001(uint pc, uint sr, uint vector);
inline static void m68ki_stack_frame_0010(uint sr, uint vector);
inline static void m68ki_stack_frame_1000(uint pc, uint sr, uint vector);
inline static void m68ki_stack_frame_1010(uint sr, uint vector, uint pc);
inline static void m68ki_stack_frame_1011(uint sr, uint vector, uint pc);

inline static void m68ki_exception_trap(uint vector);
inline static void m68ki_exception_trapN(uint vector);
inline static void m68ki_exception_trace(void);
inline static void m68ki_exception_privilege_violation(void);
inline static void m68ki_exception_1010(void);
inline static void m68ki_exception_1111(void);
inline static void m68ki_exception_illegal(void);
inline static void m68ki_exception_format_error(void);
inline static void m68ki_exception_address_error(void);
inline static void m68ki_exception_interrupt(uint int_level);
inline static void m68ki_check_interrupts(void);            /* ASG: check for interrupts */
...
/* Fetch operands */
inline static uint OPER_AY_AI_8(void)  {uint ea = EA_AY_AI_8();  return m68ki_read_8(ea); }
inline static uint OPER_AY_AI_16(void) {uint ea = EA_AY_AI_16(); return m68ki_read_16(ea);}
inline static uint OPER_AY_AI_32(void) {uint ea = EA_AY_AI_32(); return m68ki_read_32(ea);}
inline static uint OPER_AY_PI_8(void)  {uint ea = EA_AY_PI_8();  return m68ki_read_8(ea); }
inline static uint OPER_AY_PI_16(void) {uint ea = EA_AY_PI_16(); return m68ki_read_16(ea);}
inline static uint OPER_AY_PI_32(void) {uint ea = EA_AY_PI_32(); return m68ki_read_32(ea);}
inline static uint OPER_AY_PD_8(void)  {uint ea = EA_AY_PD_8();  return m68ki_read_8(ea); }
inline static uint OPER_AY_PD_16(void) {uint ea = EA_AY_PD_16(); return m68ki_read_16(ea);}
inline static uint OPER_AY_PD_32(void) {uint ea = EA_AY_PD_32(); return m68ki_read_32(ea);}
inline static uint OPER_AY_DI_8(void)  {uint ea = EA_AY_DI_8();  return m68ki_read_8(ea); }
inline static uint OPER_AY_DI_16(void) {uint ea = EA_AY_DI_16(); return m68ki_read_16(ea);}
inline static uint OPER_AY_DI_32(void) {uint ea = EA_AY_DI_32(); return m68ki_read_32(ea);}
inline static uint OPER_AY_IX_8(void)  {uint ea = EA_AY_IX_8();  return m68ki_read_8(ea); }
inline static uint OPER_AY_IX_16(void) {uint ea = EA_AY_IX_16(); return m68ki_read_16(ea);}
inline static uint OPER_AY_IX_32(void) {uint ea = EA_AY_IX_32(); return m68ki_read_32(ea);}

inline static uint OPER_AX_AI_8(void)  {uint ea = EA_AX_AI_8();  return m68ki_read_8(ea); }
inline static uint OPER_AX_AI_16(void) {uint ea = EA_AX_AI_16(); return m68ki_read_16(ea);}
inline static uint OPER_AX_AI_32(void) {uint ea = EA_AX_AI_32(); return m68ki_read_32(ea);}
inline static uint OPER_AX_PI_8(void)  {uint ea = EA_AX_PI_8();  return m68ki_read_8(ea); }
inline static uint OPER_AX_PI_16(void) {uint ea = EA_AX_PI_16(); return m68ki_read_16(ea);}
inline static uint OPER_AX_PI_32(void) {uint ea = EA_AX_PI_32(); return m68ki_read_32(ea);}
inline static uint OPER_AX_PD_8(void)  {uint ea = EA_AX_PD_8();  return m68ki_read_8(ea); }
inline static uint OPER_AX_PD_16(void) {uint ea = EA_AX_PD_16(); return m68ki_read_16(ea);}
inline static uint OPER_AX_PD_32(void) {uint ea = EA_AX_PD_32(); return m68ki_read_32(ea);}
inline static uint OPER_AX_DI_8(void)  {uint ea = EA_AX_DI_8();  return m68ki_read_8(ea); }
inline static uint OPER_AX_DI_16(void) {uint ea = EA_AX_DI_16(); return m68ki_read_16(ea);}
inline static uint OPER_AX_DI_32(void) {uint ea = EA_AX_DI_32(); return m68ki_read_32(ea);}
inline static uint OPER_AX_IX_8(void)  {uint ea = EA_AX_IX_8();  return m68ki_read_8(ea); }
inline static uint OPER_AX_IX_16(void) {uint ea = EA_AX_IX_16(); return m68ki_read_16(ea);}
inline static uint OPER_AX_IX_32(void) {uint ea = EA_AX_IX_32(); return m68ki_read_32(ea);}

inline static uint OPER_A7_PI_8(void)  {uint ea = EA_A7_PI_8();  return m68ki_read_8(ea); }
inline static uint OPER_A7_PD_8(void)  {uint ea = EA_A7_PD_8();  return m68ki_read_8(ea); }

inline static uint OPER_AW_8(void)     {uint ea = EA_AW_8();     return m68ki_read_8(ea); }
inline static uint OPER_AW_16(void)    {uint ea = EA_AW_16();    return m68ki_read_16(ea);}
inline static uint OPER_AW_32(void)    {uint ea = EA_AW_32();    return m68ki_read_32(ea);}
inline static uint OPER_AL_8(void)     {uint ea = EA_AL_8();     return m68ki_read_8(ea); }
inline static uint OPER_AL_16(void)    {uint ea = EA_AL_16();    return m68ki_read_16(ea);}
inline static uint OPER_AL_32(void)    {uint ea = EA_AL_32();    return m68ki_read_32(ea);}
inline static uint OPER_PCDI_8(void)   {uint ea = EA_PCDI_8();   return m68ki_read_pcrel_8(ea); }
inline static uint OPER_PCDI_16(void)  {uint ea = EA_PCDI_16();  return m68ki_read_pcrel_16(ea);}
inline static uint OPER_PCDI_32(void)  {uint ea = EA_PCDI_32();  return m68ki_read_pcrel_32(ea);}
inline static uint OPER_PCIX_8(void)   {uint ea = EA_PCIX_8();   return m68ki_read_pcrel_8(ea); }
inline static uint OPER_PCIX_16(void)  {uint ea = EA_PCIX_16();  return m68ki_read_pcrel_16(ea);}
inline static uint OPER_PCIX_32(void)  {uint ea = EA_PCIX_32();  return m68ki_read_pcrel_32(ea);}
 ...
 */
inline static void m68ki_fake_push_16(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP - 2);
}

inline static void m68ki_fake_push_32(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP - 4);
}

inline static void m68ki_fake_pull_16(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP + 2);
}

inline static void m68ki_fake_pull_32(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP + 4);
}
 ...
 */
inline static void m68ki_set_s_flag(uint value)
{
 ...
 */
inline static void m68ki_set_sm_flag(uint value)
{
	/* Backup the old stack pointer */
	REG_SP_BASE[FLAG_S | ((FLAG_S>>1) & FLAG_M)] = REG_SP;
...
inline static void m68ki_set_sm_flag_nosp(uint value)
{
	/* Set the S and M flags */
	FLAG_S = value & SFLAG_SET;
	FLAG_M = value & MFLAG_SET;
...
inline static void m68ki_set_ccr(uint value)
{
...
inline static void m68ki_set_sr_noint(uint value)
{
 ...
 */
inline static void m68ki_set_sr_noint_nosp(uint value)
{
	/* Mask out the "unimplemented" bits */
	value &= CPU_SR_MASK;
...
inline static void m68ki_set_sr(uint value)
{
...
inline static uint m68ki_init_exception(void)
{
...
inline static void m68ki_stack_frame_3word(uint pc, uint sr)
{
	m68ki_push_32(pc);
	m68ki_push_16(sr);
}
...
inline static void m68ki_check_interrupts(void)
{
