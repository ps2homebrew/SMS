...
static unsigned dummy[128] __attribute__((aligned (64)));
static unsigned sbuff[64] __attribute__((aligned (64)));
static struct t_SifRpcClientData cd0;

// this is a hack to avoid a bug still not identified in 
// the code causing overlap of the cd0 structure and modification
