...
static void inline DMA9Kick ( void* apDst, void* apSrc, unsigned int aQWC ) {
 __asm__ __volatile__(
  ...
  ".set noat\n\t"
  "lui  $at, 0x1001\n\t"
  "ori  " ASM_REG_T9 ", $zero, 0x0101\n\t"
  "sw   %1, -11248($at)\n\t"
  "sw   %2, -11232($at)\n\t"
  "sw   %0, -11136($at)\n\t"
  "sw   " ASM_REG_T9 ", -11264($at)\n\t"
  ".set at\n\t"
  ".set macro\n\t"
  ".set reorder\n\t"
  :: "r"( apDst ), "r"( apSrc ), "r"( aQWC ) : "at", ASM_REG_T9
 );
}  /* end DMA9Kick */ 
...
static void inline VIF0KickSPR ( void* apTag ) {
 __asm__ __volatile__(
  ...
  ".set nomacro\n\t"
  ".set noat\n\t"
  "lui  " ASM_REG_T9 ", 0x8000\n\t"
  "lui  $at, 0x1001\n\t"
  "or   %0, %0, " ASM_REG_T9 "\n\t"
  "ori  " ASM_REG_T9 ", $zero, 0x0145\n\t"
  "sw   $zero, -32736($at)\n\t"
  "sw   %0, -32720($at)\n\t"
  "sw   " ASM_REG_T9 ", -32768($at)\n\t"
  ".set at\n\t"
  ".set macro\n\t"
  ".set reorder\n\t"
  :: "r"( apTag ) : "at", ASM_REG_T9
 );
}  /* end VIF0KickSPR */
...
__asm__(
 ...
 "sll   $a1, $a1, 2\n\t"
 "1:\n\t"
 "lq    " ASM_REG_T0 ", 0x1E00($a3)\n\t"
 "lq    " ASM_REG_T1 ", 0x1E10($a3)\n\t"
 "lq    " ASM_REG_T2 ", 0x1E20($a3)\n\t"
 "lq    " ASM_REG_T3 ", 0x1E30($a3)\n\t"
 "lq    " ASM_REG_T4 ", 0x1E40($a3)\n\t"
 "ppach " ASM_REG_T0 ", " ASM_REG_T1 ", " ASM_REG_T0 "\n\t"
 "lq    " ASM_REG_T5 ", 0x1E50($a3)\n\t"
 "ppach " ASM_REG_T2 ", " ASM_REG_T3 ", " ASM_REG_T2 "\n\t"
 "lq    " ASM_REG_T6 ", 0x1E60($a3)\n\t"
 "lq    " ASM_REG_T7 ", 0x1E70($a3)\n\t"
 "addiu $a3, $a3, 128\n\t"
 "ppach " ASM_REG_T4 ", " ASM_REG_T5 ", " ASM_REG_T4 "\n\t"
 "ppach " ASM_REG_T6 ", " ASM_REG_T7 ", " ASM_REG_T6 "\n\t"
 "ppacb " ASM_REG_T0 ", " ASM_REG_T2 ", " ASM_REG_T0 "\n\t"
 "ppacb " ASM_REG_T4 ", " ASM_REG_T6 ", " ASM_REG_T4 "\n\t"
 "sq    " ASM_REG_T0 ",  0($a0)\n\t"
 "sq    " ASM_REG_T4 ", 16($a0)\n\t"
 "bne   $a3, $a2, 1b\n\t"
 "addu  $a0, $a0, $a1\n\t"
...
__asm__(
 ...
 "_transpose:\n\t"
 "mult    $v1, $a2, $a1\n\t"
 "ori     " ASM_REG_T1 ", $zero, 1\n\t"
 "or      " ASM_REG_T2 ", $zero, $a0\n\t"
 "xor     " ASM_REG_T4 ", " ASM_REG_T4 ", " ASM_REG_T4 "\n\t"
 "addiu   " ASM_REG_T5 ", $v1, -1\n\t"
 "slt     $a0, " ASM_REG_T1 ", " ASM_REG_T5 "\n\t"
 "beqz    $a0, 1f\n\t"
 "addiu   " ASM_REG_T6 ", $v1, -2\n\t"
 "blez    " ASM_REG_T6 ", 1f\n\t"
 "addiu   " ASM_REG_T3 ", " ASM_REG_T2 ", 3\n\t"
 "div     $zero, " ASM_REG_T1 ", $a1\n\t"
 "6:\n\t"
 "mfhi    $a0\n\t"
 "madd    $a0, $a2\n\t"
 "mflo    $a3\n\t"
 "slt     $v1, " ASM_REG_T1 ", $a3\n\t"
 "beqz    $v1, 3f\n\t"
 "or      " ASM_REG_T0 ", $zero, " ASM_REG_T1 "\n\t"
 "div     $zero, $a3, $a1\n\t"
 "4:\n\t"
 "or      " ASM_REG_T0 ", $zero, $a3\n\t"
 "mfhi    $a3\n\t"
 "madd    $a3, $a2\n\t"
 "mflo    $a3\n\t"
 "slt     " ASM_REG_T7 ", " ASM_REG_T1 ", $a3\n\t"
 "bnezl   " ASM_REG_T7 ", 4b\n\t"
 "div     $zero, $a3, $a1\n\t"
 "3:\n\t"
 "beql    $a3, " ASM_REG_T1 ", 5f\n\t"
 "slt     $at, " ASM_REG_T1 ", " ASM_REG_T0 "\n\t"
 "7:\n\t"
 "addiu   " ASM_REG_T1 ", " ASM_REG_T1 ", 1\n\t"
 "slt     $a3, " ASM_REG_T1 ", " ASM_REG_T5 "\n\t"
 "beqz    $a3, 1f\n\t"
 "addiu   " ASM_REG_T3 ", " ASM_REG_T3 ", 3\n\t"
 "slt     " ASM_REG_T9 ", " ASM_REG_T4 ", " ASM_REG_T6 "\n\t"
 "bnezl   " ASM_REG_T9 ", 6b\n\t"
 "div     $zero, " ASM_REG_T1 ", $a1\n\t"
 "1:\n\t"
 "jr      $ra\n\t"
 ...
 "mtc1    $a0, $f0\n\t"
 "8:\n\t"
 "div     $zero, " ASM_REG_T0 ", $a2\n\t"
 "sll     $at, " ASM_REG_T0 ", 1\n\t"
 "sll     $v0, $a3, 1\n\t"
 "addu    " ASM_REG_T7 ", $at, " ASM_REG_T0 "\n\t"
 "addu    $at, $v0, $a3\n\t"
 "addu    $a0, " ASM_REG_T7 ", " ASM_REG_T2 "\n\t"
 "addu    " ASM_REG_T9 ", $at, " ASM_REG_T2 "\n\t"
 "or      $a3, $zero, " ASM_REG_T0 "\n\t"
 "lb      " ASM_REG_T0 ", 0($a0)\n\t"
 "lb      " ASM_REG_T7 ", 1($a0)\n\t"
 "mfhi    " ASM_REG_T8 "\n\t"
 "lb      $at, 2($a0)\n\t"
 "madd    " ASM_REG_T8 ", $a1\n\t"
 "sb      " ASM_REG_T0 ", 0(" ASM_REG_T9 ")\n\t"
 "sb      " ASM_REG_T7 ", 1(" ASM_REG_T9 ")\n\t"
 "sb      $at, 2(" ASM_REG_T9 ")\n\t"
 "mflo    " ASM_REG_T0 "\n\t"
 "slt     $at, " ASM_REG_T1 ", " ASM_REG_T0 "\n\t"
 "bnez    $at, 8b\n\t"
 "addiu   " ASM_REG_T4 ", " ASM_REG_T4 ", 1\n\t"
 "sll     $v1, $a3, 1\n\t"
 "addu    " ASM_REG_T0 ", $v1, $a3\n\t"
 "mfc1    $v1, $f0\n\t"
 "addu    " ASM_REG_T8 ", " ASM_REG_T0 ", " ASM_REG_T2 "\n\t"
 "sb      $v1, 0(" ASM_REG_T8 ")\n\t"
 "srl     $v1, $v1, 8\n\t"
 "sb      $v1, 1(" ASM_REG_T8 ")\n\t"
 "srl     $v1, $v1, 8\n\t"
