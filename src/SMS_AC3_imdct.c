...
static void SMS_INLINE _ifft2 ( sample_t* apBuf ) {
 ...
 __asm__ __volatile__ (
  ...
  "ld        " ASM_REG_T1 ", 24(%0)\n\t"
  "paddw     $at, " ASM_REG_T0 ", " ASM_REG_T1 "\n\t"
  ...
  "sd        " ASM_REG_T0 ",  8(%0)\n\t"
  ".set at\n\t"
  :: "r"( apBuf ) : ASM_REG_T0, ASM_REG_T1, "at", "memory"
 );
...
static void SMS_INLINE _ifft4 ( sample_t* apBuf ) {
 ...
 __asm__ __volatile__(
  ...
  "prot3w    " ASM_REG_T1 ", " ASM_REG_T1 "\n\t"
  "pcpyld    $at, " ASM_REG_T1 ", " ASM_REG_T0 "\n\t"
  "pcpyud    " ASM_REG_T0 ", " ASM_REG_T0 ", " ASM_REG_T1 "\n\t"
  "paddw     " ASM_REG_T1 ", $at, " ASM_REG_T0 "\n\t"
  "psubw     " ASM_REG_T0 ", $at, " ASM_REG_T0 "\n\t"
  "prot3w    " ASM_REG_T0 ", " ASM_REG_T0 "\n\t"
  "pexcw     " ASM_REG_T0 ", " ASM_REG_T0 "\n\t"
  "pcpyld    $at, " ASM_REG_T0 ", " ASM_REG_T1 "\n\t"
  "pcpyud    " ASM_REG_T1 ", " ASM_REG_T1 ", " ASM_REG_T0 "\n\t"
  "paddw     " ASM_REG_T0 ", $at, " ASM_REG_T1 "\n\t"
  "psubw     " ASM_REG_T1 ", $at, " ASM_REG_T1 "\n\t"
...
__asm__(
 ...
 "nor       $at, $zero, $zero\n\t"
 "pexew     $at, $at\n\t"
 "psrlw     " ASM_REG_T2 ", $at, 31\n\t"
 "pextlw    $v0, " ASM_REG_T1 ", " ASM_REG_T0 "\n\t"
 "pextlw    $v1, " ASM_REG_T0 ", " ASM_REG_T1 "\n\t"
 "mtsah     $zero, 4\n\t"
 "pxor      $at, $v1, $at\n\t"
 "paddw     $at, $at, " ASM_REG_T2 "\n\t"
 "paddw     $at, $v0, $at\n\t"
 "ld        " ASM_REG_T0 ", 0($a0)\n\t"
 "pexew     $at, $at\n\t"
 "ld        " ASM_REG_T1 ", 0($a1)\n\t"
 ...
 "psubw     " ASM_REG_T1 ", " ASM_REG_T0 ", $at\n\t"
 "paddw     " ASM_REG_T0 ", " ASM_REG_T0 ", $at\n\t"
 "sd        " ASM_REG_T1 ", 0($a2)\n\t"
 ...
 "lw      " ASM_REG_T3 ", 0($a3)\n\t"
 "lw      " ASM_REG_T4 ", 4($a3)\n\t"
 "addu    $v0, " ASM_REG_T1 ", " ASM_REG_T2 "\n\t"
 "subu    $v1, " ASM_REG_T2 ", " ASM_REG_T1 "\n\t"
 "pextlw  $v0, $v1, $v0\n\t"
 "subu    $v1, " ASM_REG_T3 ", " ASM_REG_T4 "\n\t"
 "addu    $at, " ASM_REG_T3 ", " ASM_REG_T4 "\n\t"
 "pextlw  $v1, $at, $v1\n\t"
 "pcpyld  $v0, $v1, $v0\n\t"
 "pextlw  " ASM_REG_T0 ", " ASM_REG_T0 ", " ASM_REG_T0 "\n\t"
 "pcpyld  " ASM_REG_T0 ", " ASM_REG_T0 ", " ASM_REG_T0 "\n\t"
 "prevh   " ASM_REG_T0 ", " ASM_REG_T0 "\n\t"
 "phmadh  $at, $v0, " ASM_REG_T0 "\n\t"
 "psraw   $v0, $v0, 16\n\t"
 "pmulth  $v0, $v0, " ASM_REG_T0 "\n\t"
 "mtsah   $zero, 2\n\t"
 "psraw   $at, $at, 14\n\t"
 "psllw   $v0, $v0, 2\n\t"
 "paddw   $v0, $v0, $at\n\t"
 ...
 "ld      " ASM_REG_T1 ", 0($a1)\n\t"
 "pcpyld  " ASM_REG_T0 ", " ASM_REG_T1 ", " ASM_REG_T0 "\n\t"
 "psubw   " ASM_REG_T1 ", " ASM_REG_T0 ", $v0\n\t"
 "paddw   " ASM_REG_T0 ", " ASM_REG_T0 ", $v0\n\t"
 "pcpyud  $v0, " ASM_REG_T1 ", " ASM_REG_T1 "\n\t"
 "pcpyud  $v1, " ASM_REG_T0 ", " ASM_REG_T0 "\n\t"
 "sd      " ASM_REG_T0 ", 0($a0)\n\t"
 "sd      $v1, 0($a1)\n\t"
 "sd      " ASM_REG_T1 ", 0($a2)\n\t"
 "jr      $ra\n\t"
