...
__asm__(
 ...
 "lq        " ASM_REG_T3 ",  16(" ASM_REG_T0 ")\n\t"
 "lq        " ASM_REG_T4 ",  32(" ASM_REG_T0 ")\n\t"
 "lq        " ASM_REG_T5 ",  48(" ASM_REG_T0 ")\n\t"
 "lq        " ASM_REG_T6 ",  64(" ASM_REG_T0 ")\n\t"
 "lq        " ASM_REG_T7 ",  80(" ASM_REG_T0 ")\n\t"
 "lq        " ASM_REG_T8 ",  96(" ASM_REG_T0 ")\n\t"
 "lq        " ASM_REG_T9 ", 112(" ASM_REG_T0 ")\n\t"
 "ppacw     $at, " ASM_REG_T3 ", " ASM_REG_T2 "\n\t"
 "pextlw    $v1, " ASM_REG_T3 ", " ASM_REG_T2 "\n\t"
 "pextuw    " ASM_REG_T2 ", " ASM_REG_T3 ", " ASM_REG_T2 "\n\t"
 "pextuw    " ASM_REG_T2 ", " ASM_REG_T2 ", $v1\n\t"
 "ppacw     " ASM_REG_T3 ", " ASM_REG_T5 ", " ASM_REG_T4 "\n\t"
 "pextlw    $v1, " ASM_REG_T5 ", " ASM_REG_T4 "\n\t"
 "pextuw    " ASM_REG_T4 ", " ASM_REG_T5 ", " ASM_REG_T4 "\n\t"
 "pextuw    " ASM_REG_T4 ", " ASM_REG_T4 ", $v1\n\t"
 "ppacw     " ASM_REG_T5 ", " ASM_REG_T7 ", " ASM_REG_T6 "\n\t"
 "pextlw    $v1, " ASM_REG_T7 ", " ASM_REG_T6 "\n\t"
 "pextuw    " ASM_REG_T6 ", " ASM_REG_T7 ", " ASM_REG_T6 "\n\t"
 "pextuw    " ASM_REG_T6 ", " ASM_REG_T6 ", $v1\n\t"
 "ppacw     " ASM_REG_T7 ", " ASM_REG_T9 ", " ASM_REG_T8 "\n\t"
 "pextlw    $v1, " ASM_REG_T9 ", " ASM_REG_T8 "\n\t"
 "pextuw    " ASM_REG_T8 ", " ASM_REG_T9 ", " ASM_REG_T8 "\n\t"
 "pextuw    " ASM_REG_T8 ", " ASM_REG_T8 ", $v1\n\t"
 "qmtc2     $at, $vf5\n\t"
 "qmtc2     " ASM_REG_T2 ", $vf6\n\t"
 "qmtc2     " ASM_REG_T3 ", $vf7\n\t"
 "qmtc2     " ASM_REG_T4 ", $vf8\n\t"
 "qmtc2     " ASM_REG_T5 ", $vf9\n\t"
 "qmtc2     " ASM_REG_T6 ", $vf10\n\t"
 "qmtc2     " ASM_REG_T7 ", $vf11\n\t"
 "qmtc2     " ASM_REG_T8 ", $vf12\n\t"
 "qfsrv     " ASM_REG_T8 ", " ASM_REG_T8 ", " ASM_REG_T6 "\n\t"
 "qfsrv     " ASM_REG_T7 ", " ASM_REG_T6 ", " ASM_REG_T4 "\n\t"
 "qfsrv     " ASM_REG_T6 ", " ASM_REG_T4 ", " ASM_REG_T2 "\n\t"
 "qfsrv     " ASM_REG_T5 ", " ASM_REG_T2 ", $zero\n\t"
 "qmtc2     " ASM_REG_T8 ", $vf13\n\t"
 "qmtc2     " ASM_REG_T7 ", $vf14\n\t"
 "qmtc2     " ASM_REG_T6 ", $vf15\n\t"
 "qmtc2     " ASM_REG_T5 ", $vf16\n\t"
 "addiu     $at, " ASM_REG_T1 ", 2176\n\t"
 "addiu     " ASM_REG_T2 ", $v0,  112\n\t"
 ...
 "1:\n\t"
 "lqc2      $vf9,   0(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf10,  16(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf11,  32(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf12,  48(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf13,  64(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf14,  80(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf15,  96(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf16, 112(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf17, 128(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf18, 144(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf19, 160(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf20, 176(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf21, 192(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf22, 208(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf23, 224(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf24, 240(" ASM_REG_T1 ")\n\t"
 ...
 "lqc2      $vf10, 256(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf11, 272(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf12, 288(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf13, 304(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf14, 320(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf15, 336(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf16, 352(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf17, 368(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf18, 384(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf19, 400(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf20, 416(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf21, 432(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf22, 448(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf23, 464(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf24, 480(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf25, 496(" ASM_REG_T1 ")\n\t"
 ...
 "lqc2      $vf11, 512(" ASM_REG_T1 ")\n\t"
 "lqc2      $vf12, 528(" ASM_REG_T1 ")\n\t"
 ...
 "addiu     " ASM_REG_T1 ", " ASM_REG_T1 ", 544\n\t"
 "qmfc2     $v1, $vf12\n\t"
 "pexew     $v1, $v1\n\t"
 "qfsrv     $v1, $v1, $v1\n\t"
 "sqc2      $vf11, 0($v0)\n\t"
 "sq        $v1, 0(" ASM_REG_T2 ")\n\t"
 "addiu     $v0, $v0,  16\n\t"
 "bne       $at, " ASM_REG_T1 ", 1b\n\t"
 "addiu     " ASM_REG_T2 ", " ASM_REG_T2 ", -16\n\t"
 "pxor      $at, $at, $at\n\t"
 "qmtc2     $at, $vf1\n\t"
 "addiu     " ASM_REG_T3 ", $a1, 2048\n\t"
 "1:\n\t"
 "pref      0, 128($a2)\n\t"
 "addiu     " ASM_REG_T2 ", $a0, 0\n\t"
 "addiu     $at, $a1, 128\n\t"
 "addiu     $v1, $a1, 112\n\t"
 "2:\n\t"
 "lqc2      $vf2,   0(" ASM_REG_T2 ")\n\t"
 "lqc2      $vf3, 128(" ASM_REG_T2 ")\n\t"
 "lqc2      $vf4,   0($a2)\n\t"
 "lqc2      $vf5, 128($a2)\n\t"
 "lqc2      $vf6,   0($a1)\n\t"
 "lq        $v0, 0($v1)\n\t"
 ...
 "addiu     " ASM_REG_T2 ", " ASM_REG_T2 ",  16\n\t"
 "addiu     $v1, $v1, -16\n\t"
 "sqc2      $vf2, -16(" ASM_REG_T2 ")\n\t"
 "bne       $at, $a1, 2b\n\t"
 "sqc2      $vf3, 112(" ASM_REG_T2 ")\n\t"
 "addiu     $a1, $a1, 128\n\t"
 "bne       " ASM_REG_T3 ", $a1, 1b\n\t"
 "addiu     $a2, $a2, 128\n\t"
 "pref      0,  0($a0)\n\t"
 "pref      0, 64($a0)\n\t"
 "lq        " ASM_REG_T0 ", 128($a0)\n\t"
 "lq        " ASM_REG_T1 ", 144($a0)\n\t"
 "lq        " ASM_REG_T2 ", 160($a0)\n\t"
 "lq        " ASM_REG_T3 ", 176($a0)\n\t"
 "lq        " ASM_REG_T4 ", 192($a0)\n\t"
 "lq        " ASM_REG_T5 ", 208($a0)\n\t"
 "lq        " ASM_REG_T6 ", 224($a0)\n\t"
 "lq        " ASM_REG_T7 ", 240($a0)\n\t"
 "lqc2      $vf1,   0($a0)\n\t"
 "lqc2      $vf2,  16($a0)\n\t"
 "lqc2      $vf3,  32($a0)\n\t"
 "lqc2      $vf4,  48($a0)\n\t"
 ...
 "sq        " ASM_REG_T5 ",  80($a0)\n\t"
 "sq        " ASM_REG_T6 ",  96($a0)\n\t"
 "sq        " ASM_REG_T7 ", 112($a0)\n\t"
 "addiu     $at, $a1, -2048\n\t"
 "1:\n\t"
 "lq        " ASM_REG_T0 ", -192($a1)\n\t"
 "lq        " ASM_REG_T1 ", -176($a1)\n\t"
 "lq        " ASM_REG_T2 ", -160($a1)\n\t"
 "lq        " ASM_REG_T3 ", -144($a1)\n\t"
 "addiu     $a1, $a1, -64\n\t"
 "sq        " ASM_REG_T0 ",   0($a1)\n\t"
 "sq        " ASM_REG_T1 ",  16($a1)\n\t"
 "sq        " ASM_REG_T2 ",  32($a1)\n\t"
...
__asm__(
 ...
 "lq        " ASM_REG_T0 ",    0($a1)\n\t"
 "lq        " ASM_REG_T1 ",   16($a1)\n\t"
 "lq        " ASM_REG_T2 ", 1024($a1)\n\t"
 "lq        " ASM_REG_T3 ", 1040($a1)\n\t"
 "addiu     $a1, $a1, 32\n\t"
 "addiu     $a0, $a0, 32\n\t"
 "psubw     " ASM_REG_T0 ", " ASM_REG_T0 ", $at\n\t"
 "psubw     " ASM_REG_T1 ", " ASM_REG_T1 ", $at\n\t"
 "psubw     " ASM_REG_T2 ", " ASM_REG_T2 ", $at\n\t"
 "psubw     " ASM_REG_T3 ", " ASM_REG_T3 ", $at\n\t"
 ...
 "pinteh    " ASM_REG_T0 ", " ASM_REG_T2 ", " ASM_REG_T0 "\n\t"
 "pinteh    " ASM_REG_T1 ", " ASM_REG_T3 ", " ASM_REG_T1 "\n\t"
 "sq        " ASM_REG_T0 ", -32($a0)\n\t"
 "bne       $a1, $a2, 1b\n\t"
 "sq        " ASM_REG_T1 ", -16($a0)\n\t"
 "jr    $ra\n\t"
...
__asm__(
 ...
 "lq        " ASM_REG_T9 ", 16($a1)\n\t"
 "lq        $at, 32($a1)\n\t"
 "qfsrv     $v1, " ASM_REG_T9 ", $v1\n\t"
 "qfsrv     " ASM_REG_T9 ", $at, " ASM_REG_T9 "\n\t"
 ...
 *( int* )lpOutBuf = retVal;
 ...
 __asm__ __volatile__(
  ...
  :: "r"( lpOutBuf + 8 ), "r"( s_DTSCtx.m_InBuf ), "r"( aLen + 31 )
   : "v1", ASM_REG_T6, ASM_REG_T7, ASM_REG_T8, ASM_REG_T9, "at"
 );
