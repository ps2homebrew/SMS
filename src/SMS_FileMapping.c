...
__asm__(
 ...
 "sq    $a2,  96($k0)\n\t"
 "sq    $a3, 112($k0)\n\t"
 "sq    " ASM_REG_T0 ", 128($k0)\n\t"
 "sq    " ASM_REG_T1 ", 144($k0)\n\t"
 "sq    " ASM_REG_T2 ", 160($k0)\n\t"
 "sq    " ASM_REG_T3 ", 176($k0)\n\t"
 "sq    " ASM_REG_T4 ", 192($k0)\n\t"
 "sq    " ASM_REG_T5 ", 208($k0)\n\t"
 "sq    " ASM_REG_T6 ", 224($k0)\n\t"
 "sq    " ASM_REG_T7 ", 240($k0)\n\t"
 "sq    " ASM_REG_T8 ", 256($k0)\n\t"
 "sq    " ASM_REG_T9 ", 272($k0)\n\t"
 "sq    $s0, 288($k0)\n\t"
 "sq    $s1, 304($k0)\n\t"
 "sq    $s2, 320($k0)\n\t"
 "sq    $s3, 336($k0)\n\t"
...
__asm__(
 ...
 "lq    $a2,  96($k0)\n\t"
 "lq    $a3, 112($k0)\n\t"
 "lq    " ASM_REG_T0 ", 128($k0)\n\t"
 "lq    " ASM_REG_T1 ", 144($k0)\n\t"
 "lq    " ASM_REG_T2 ", 160($k0)\n\t"
 "lq    " ASM_REG_T3 ", 176($k0)\n\t"
 "lq    " ASM_REG_T4 ", 192($k0)\n\t"
 "lq    " ASM_REG_T5 ", 208($k0)\n\t"
 "lq    " ASM_REG_T6 ", 224($k0)\n\t"
 "lq    " ASM_REG_T7 ", 240($k0)\n\t"
 "lq    " ASM_REG_T8 ", 256($k0)\n\t"
 "lq    " ASM_REG_T9 ", 272($k0)\n\t"
 "lq    $s0, 288($k0)\n\t"
 "lq    $s1, 304($k0)\n\t"
 "lq    $s2, 320($k0)\n\t"
 "lq    $s3, 336($k0)\n\t"
